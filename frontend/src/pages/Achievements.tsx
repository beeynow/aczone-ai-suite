...
export default function Achievements() {
  ...
  const [userAchievementData, setUserAchievementData] = useState<Map<string, UserAchievement>>(new Map());
  ...
  const loadAchievements = async () => {
    try {
      ...
      const { data: unlockedAchievements, error: userAchievementsError } = await supabase
      ...
      const unlockedSet = new Set<string>(unlockedAchievements?.map((ua) => ua.achievement_id) || []);
