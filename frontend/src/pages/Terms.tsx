      ...
      <Card className="p-6 space-y-6">
        <section>
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              By using Tryinterview, you agree to these terms. Please read them
              carefully.
            </p>
            <p>
              Tryinterview provides AI-powered generation tools for personal and
        ...
        <section>
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              Tryinterview is provided "as is" without warranties. We are not liable
        ...
        <section>
          ...
          <p className="text-sm text-muted-foreground">
            For questions about these terms, contact us at support@tryinterview.site
          </p>
        </section>
      </Card>
    </div>
