import { ENUM_REMOTE_TYPE, ZEGO_ENV, LOG_LEVEL_STR, DataStatisticsItem, LogExtendFields, LogConfig } from './zego.entity';
...
export declare class ZegoLogger {
     ...
     * 设置上报ZipLog的域名
     */
    setZipLogUploadUrl(urls: string[], v6Urls: string[]): void;
    /**
     * 清除持久化的日志并上报（日志）
     */
