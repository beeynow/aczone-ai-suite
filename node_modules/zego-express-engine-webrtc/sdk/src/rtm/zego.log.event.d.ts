...
export declare const kZegoConnConnected: {
    event: string;
    connect_type: (item: number) => number;
    time_consumed: (item: number) => number;
    url: (item?: string) => string | undefined;
};
export declare const kZegoConnConnectFailed: {
    event: string;
    connect_type: (item: number) => number;
    url: (item?: string) => string | undefined;
    error: (item: number) => number;
    err_msg: (item?: string) => string | undefined;
    online: (item: number) => number;
};
export declare const kZegoConnConnectBackToWs: {
    event: string;
    connect_type: (item: number) => number;
    url: (item?: string) => string | undefined;
    reason: (item: number) => number;
    err_msg: (item?: string) => string | undefined;
};
