import { ZegoLogger, ZegoRoomInfo, ZReporter, ZegoDataReport, ZegoScenario, ZegoNetmode, AutoSwitchDeviceConfig, SEIConfig, ENUM_NETWORK_STATE, EngineConfig } from './zego.entity';
